...
2. Download TheiaTools from the corresponding [release](https://github.com/qualisys/paf-theia-markerless-comparison-example/releases/latest) and move the extracted contents into the `Templates/Assets/Programs/Theia-Tools/` folder in the project directory.
